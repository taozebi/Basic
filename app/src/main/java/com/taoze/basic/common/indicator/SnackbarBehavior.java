package com.taoze.basic.common.indicator;
...
public class SnackbarBehavior extends CoordinatorLayout.Behavior<CircleIndicator> {
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, CircleIndicator child,
                                   View dependency) {
        return dependency instanceof Snackbar.SnackbarLayout;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, CircleIndicator child,
                                          View dependency) {
