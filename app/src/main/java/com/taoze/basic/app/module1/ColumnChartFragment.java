...
public class ColumnChartFragment extends BaseFragment {
    ...
    @BindView(R.id.mColumnChartView)
    ...
    protected View onCreateContentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_column_chart,null);
    }

    @Override
    protected void onInitData() {
        titleBar.setTitleText("ColumnChart");
        titleBar.setBackBtnVisibility(true);
        titleBar.setSubmitBtnVisibility(false);
        titleBar.inflateMenu(R.menu.menu_column_chart);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_column_touch_zoom:
                        mColumnChartView.setZoomEnabled(!mColumnChartView.isZoomEnabled());   //全局缩放
                        return true;
                    case R.id.menu_column_touch_zoom_xy:
                        mColumnChartView.setZoomType(ZoomType.HORIZONTAL_AND_VERTICAL);      //水平垂直缩放
                        return true;
                    case R.id.menu_column_touch_zoom_x:
                        mColumnChartView.setZoomType(ZoomType.HORIZONTAL);                   //水平缩放
                        return true;
                    case R.id.menu_column_touch_zoom_y:
                        mColumnChartView.setZoomType(ZoomType.VERTICAL);                     //垂直缩放
                        return true;
                }
                return true;
            }
    ...
    private void changeColumnsAnimate(boolean isNegative) {
        ...
        mColumnChartView.startDataAnimation();               //开始动画
    }
    ...
    private void showOrHideLablesByColumnsSelected() {
        ...
        mColumnChartView.setValueSelectionEnabled(isColumnsHasSelected);   //设置选中状态
    ...
    private class ValueTouchListener implements ColumnChartOnValueSelectListener {
        ...
        public void onValueSelected(int columnIndex, int subcolumnIndex, SubcolumnValue value) {
            T.showShort(getActivity(),"当前列的值约为 " + (int) value.getValue());
        }
